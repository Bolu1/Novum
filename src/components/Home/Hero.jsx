          ...
          <div className="w-[40rem] h-full flex  flex-col justify-center ">
            ...
            <div className="mt-7 relative">
              ...
              <div className="w-10 h-40  absolute 2xl:-left-10 lg:left-5 top-32 flex-col space-y-4">
                <div
                  href="#_"
                  class="rounded-full cursor-pointer w-8 h-8 flex justify-center items-center border-gray-500 border hover:bg-white hover:text-black transition ease-in duration-300"
                >
