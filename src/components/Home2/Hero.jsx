        ...
        <div className="h-[45rem] overflow-hidden relative  backdrop-brightness-80">
          ...
          <div className="absolute w-[90%]  top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            ...
            <div className=" mt-2 space-y-4">
              ...
              <button
               class="px-4 py-4 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-customblue rounded-lg hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
               <a href="#appointment">
                Book Appointment
                </a>
              </button>
